...
describe('Table node with text page ', () => {
...
//============================================Table node============
cy.get('div.react-flow__node div')
  .filter((_, el) => el.innerText.trim() === 'T')
  .first()
  .click({ force: true });
...
cy.get('button[title="Show Backward Connections"]')
  .scrollIntoView()
  .click({ force: true });
cy.wait(1000);

  cy.get('button[title="Close Backward Connections"]').click({ force: true });
//======================================================================================================================
cy.wait(1000);
cy.get('button[title="Column Level Details"]').click({ force: true });
//================================================================================================================
...
cy.get('[data-handleid="target-0-age"]').click();
cy.wait(2000);
cy.get('[data-handleid="target-0-age"]').click();
cy.wait(2000);
