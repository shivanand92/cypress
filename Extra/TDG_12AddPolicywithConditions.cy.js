describe('Add Policy With Conditions', () => {
  let credentials;
...
cy.wait(500);
    cy.get('input.w-full.p-2.border.border-gray-300.rounded-md.text-sm').eq(0).type('3');
    cy.wait(1000);
    
   //=======one more Condtition
   cy.contains('button', 'Add Condition').click(); 
   cy.wait(1000);
   cy.get('select.w-32.p-2.border.border-gray-300.rounded-md.text-sm').select('AND');
   cy.wait(1000);
cy.get('select.w-full.p-2.border.border-gray-300.rounded-md.text-sm').eq(2).select('age');
    cy.wait(500);
    cy.get('select.w-full.p-2.border.border-gray-300.rounded-md.text-sm').eq(3).select('=');
cy.wait(500);
    cy.get('input.w-full.p-2.border.border-gray-300.rounded-md.text-sm').eq(1).type('43');
   cy.contains('button', 'Next').click();
//=====================================================================================================
//============================================ condtions over=============================================
