...
describe('Metadata Creation with multipletables', () => {
  let loginData;
  let metadata;
  ...
  it('Logs in and creates a migration', () => {
    ...
    cy.wait(1000);
    cy.get('input[placeholder="Search datasets..."]').clear();
    cy.get('input[placeholder="Search datasets..."]').type(metadata.sourceTable1);
    cy.wait(1000);
    cy.get('input#table-0').click();
